...
public class ExtentManager {
    ...
    public static synchronized ExtentReports getExtentReports() {
        if (extent == null) {
            ...
            spark.config().setDocumentTitle("Bakuelectronics Automation Test Result");
            spark.config().setReportName("Bakuelectronics Regression Test Suite");
            ...
            extent.setSystemInfo("Tester", "Fuad Gulmammadov");
